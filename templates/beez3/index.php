...
$this->setGenerator('Рок-мастерская Dee Boro | Продажа рок-атрибутики | deeboro.ru');
		...
		<div id="all">
			<div id="back">
				<header id="header">
               	  <div class="container">
                    <div class="contactt">
  						<p class="top-contact">+7-923-508-06-66</p>                      	
                   	</div>
                    <div class="pozvon">                      
                      <p class="poz-contact"><a id="show_callback" href="javascript:void(0)" title="Открыть">Позвонить Вам?</a></p>
                      <jdoc:include type="modules" name="pozvon" />                      
                    </div>
                    <div class="napis">
                      <p class="nap-contact"><a id="show_callback" href="/index.php?option=com_contact&amp;view=contact&amp;id=2">Написать нам</a></p>
                    </div>
					<div class="logoheader">                      
						<h1 id="logo">                          
						<?php if ($logo) : ?>
							<a href="http://deeboro.ru/";><img src="<?php echo $this->baseurl; ?>/<?php echo htmlspecialchars($logo); ?>"  alt="<?php echo htmlspecialchars($templateparams->get('sitetitle')); ?>" /></a>
						<?php endif;?>
				...
				<div id="<?php echo $showRightColumn ? 'contentarea2' : 'contentarea'; ?>">
					...
					<div id="<?php echo $showRightColumn ? 'wrapper' : 'wrapper2'; ?>" <?php if (isset($showno)){echo 'class="shownocolumns"';}?>>
						<div id="main">
							...
							<?php endif; ?>
							<div id="<?php echo $showRightColumn ? 'slide' : 'slide'; ?>">                             	
									<jdoc:include type="modules" name="slider"/>
							</div>
                          	<div id="lider">
								<jdoc:include type="modules" name="lider" style="xhtml"/>
							</div>
			...
			<div id="footer-sub">
				<footer id="footer">                  
                                <div class="containerr">
                                 	<div class="logoniz">                                                         
                     					<a href="http://deeboro.ru/";><img src="/images/Logo_white1.png"></a>
                  					</div>
                                  <div class="menuniz">
                                    <p id="nizmenu">
                                      <a href="">Главная</a>   |    <a href="/index.php/o-magazine">О магазине</a>   |    <a href="/index.php/dostavka-i-oplata">Доставка и оплата</a>   |    <a href="/index.php/otzyvy">Отзывы</a>
                                    </p>
                                  </div>
                                  <div class="infa">
 									 <li class="bottom-contact"><i class="icon-map-marker"></i>«Dee Boro» 2015</li>  
      								 <li class="bottom-contact"><i class="icon-phone"></i>+7-923-508-06-66</li>
    								 <li class="bottom-contact"><i class="icon-envelope-alt"></i><a href="mailto:deeboro@yandex.ru">deeboro@yandex.ru</a></li>
  									 <p></p>              
                                  </div>
             					 </div>	
